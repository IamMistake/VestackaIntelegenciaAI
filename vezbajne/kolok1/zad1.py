...
class GhostOnSkates(Problem):
    def __init__(self, initial, walls, n, goal=None):
        ...
        self.walls = walls
        self.n = n
        # self.directions = ("Desno ", "Gore ")
        self.directions = ("Gore ", "Desno ")
        ...
        for direction in self.directions:
            for i in range(1, 4):
                ...
                if direction == "Gore ":
                    ...
                    duh[0] += i
                if GhostOnSkates.check_valid(tuple(duh), self.walls, self.n):
                    continue

                name = direction + str(i)
                successors[name] = tuple(duh)
...
if __name__ == '__main__':
    ...
    # result2 = greedy_best_first_graph_search(problem)
